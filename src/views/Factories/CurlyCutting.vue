<template>
  <section class="pb-20">
    ...
    >
      <ul class="basicTab">
        <li
          v-if="$can('read', 'factories-curly-cutting-coming-raw')"
        ...
        <li
          v-if="$can('read', 'factories-curly-cutting-coming-ready')"
        ...
        <li
          v-if="$can('read', 'factories-curly-cutting-expense')"
        ...
        <li
          v-if="$can('read', 'factories-curly-cutting-warehouse')"
        ...
        <li
          v-if="$can('read', 'factories-curly-cutting-ready-warehouse')"
      ...
      <button
        v-if="$can('read', 'factories-curly-cutting-produce')"
        @click="toggleModal()"
        :class="params.currentTable === 'table-4' ? 'opacity-0' : ''"
    ...
    <div class="a-table border-b-[1.5px] borderBox dark:border-[#1a283a] min-h-[500px]">
      <div class="table-1" v-if="params.currentTable === 'table-1' && $can('read', 'factories-curly-cutting-coming-raw')">
        <div class="wrapper">
          ...
          <div class="a-table-body" v-if="!isLoading && !isError">
            ...
            >
              <li class="uk-width-expand">
                <h3 class="a-table-text  main-color-black" :class="$isDark ? 'dark' : ''"> {{ $dayjs(item.created_at).format('DD-MM-YYYY, HH:mm') }}</h3>
              </li>
              <li class="uk-width-expand">
      ...
      <div class="table-2" v-if="params.currentTable === 'table-2' && $can('read', 'factories-curly-cutting-coming-ready')">
        <div class="wrapper">
          <div class="a-table-header">
            <ul class="uk-grid-collapse a-table-list" uk-grid>
          <li class="uk-width-expand">
...
<!-- 
      ...
      <div class="table-3" v-if="params.currentTable === 'table-3' && $can('read', 'factories-curly-cutting-expense')">
        <div class="wrapper">
          <div class="a-table-header">
            <ul class="uk-grid-collapse a-table-list" uk-grid>
              <li class="uk-width-expand">
      ...
      <div class="table-4 h-full" v-if="params.currentTable === 'table-4' && $can('read', 'factories-curly-cutting-warehouse')">
                ...
                <div class="uk-grid-collapse uk-child-width-1-2 h-full" uk-grid>
                  <div>
                    <div class="border-r-[1.5px] borderBox dark:border-[#1a283a] pr-10 h-full">
                      ...
                      <Skeleton v-if="isLoading && $route.query.table == 'table-4'" classes="w-full min-h-[500px] " />
                  ...
                  <div>
                    <div class="pl-10">
                      ...
                      <Skeleton v-if="isLoading && $route.query.table == 'table-4'" classes="w-full min-h-[500px] " />
                      <null-data v-else-if="isErrorLeft || !storeListRight.length" width='w-[120px]' classes='h-full min-h-[500px] ' />
                    </div>
                  </div>
                </div>
              </div>
       ...
       <div class="table-5 h-full" v-if="params.currentTable === 'table-5' && $can('read', 'factories-curly-cutting-ready-warehouse')">
        <div class="wrapper h-full">
          <div
            class="uk-grid-medium uk-grid-match uk-child-width-expand h-full"
            uk-grid
    ...
    <curlyCuttingModal :isModalActive="isModalActive" v-if="$can('read', 'factories-curly-cutting-produce')"/>
...
import curlyCuttingModal from './components/curlyCuttingModal.vue'
...
export default {
  ...
  setup() {
    ...
    const changeTable = async (e) => {
      router.push(`/curly-cutting-factory?table=${e}`)
