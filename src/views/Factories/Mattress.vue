<template>
  <section class="pb-20">
    ...
    >
      <ul class="basicTab">
        <li
          v-if="$can('read', 'factories-mattress-coming-raw')"
        ...
        <li
          v-if="$can('read', 'factories-mattress-coming-ready')"
        ...
        <li
          v-if="$can('read', 'factories-mattress-expense')"
        ...
        <li
          v-if="$can('read', 'factories-mattress-warehouse')"
        ...
        <li
          v-if="$can('read', 'factories-mattress-ready-warehouse')"
      ...
      <button
        v-if="$can('read', 'factories-mattress-produce')"
        @click="toggleModal()"
    ...
    <div class="a-table border-b-[1.5px] borderBox dark:border-[#1a283a] min-h-[500px]">
      ...
      <div class="table-1" v-if="params.currentTable === 'table-1' && $can('read', 'factories-mattress-coming-raw')">
        <div class="wrapper">
            ...
            >
              ...
              <li class="w-[100px] relative">
                  ...
                  <div
                    ...
                    :class="$isDark ? 'text-[#66b2ff]' : 'text-[#5FC7D1]'"
                  >
                    <FunctionsIcon
      ...
      <div class="table-2" v-if="params.currentTable === 'table-2' && $can('read', 'factories-mattress-coming-ready')">
        <div class="wrapper">
          <div class="a-table-header">
            <ul class="uk-grid-collapse a-table-list" uk-grid>
              <li class="uk-width-expand">
      ...
      <div class="table-2" v-if="params.currentTable === 'table-3' && $can('read', 'factories-mattress-expense')">
        <div class="wrapper">
          <div class="a-table-header">
            <ul class="uk-grid-collapse a-table-list" uk-grid>
              <li class="uk-width-expand">
       ...
       <div class="table-4" v-if="params.currentTable === 'table-4' && $can('read', 'factories-mattress-warehouse')">
        <div class="wrapper">
          <div
      ...
      <div class="table-5 h-full" v-if="params.currentTable === 'table-5' && $can('read', 'factories-mattress-ready-warehouse')">
        <div class="wrapper">
          <div
    ...
    <mattressModal :isModalActive="isModalActive" v-if="$can('read', 'factories-mattress-produce')"/>
...
import mattressModal from './components/mattressModal.vue'
...
export default {
  ...
  setup() {
    ...
    const deleteProductStore = async (id) => {
      ...
      await factoryIncomeStorage.DELETE_STORAGE_PRODUCT(id).then((response) => {
          if (response.data) {
