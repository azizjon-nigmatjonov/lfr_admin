<template>
  <section class="pb-20">
    ...
    >
      <ul class="basicTab">
        <li
          v-if="$can('read', 'factories-sponge-coming-raw')"
        ...
        <li
          v-if="$can('read', 'factories-sponge-coming-ready')"
        ...
        <li
          v-if="$can('read', 'factories-sponge-expense')"
        ...
        <li
          v-if="$can('read', 'factories-sponge-warehouse')"
        ...
        <li
          v-if="$can('read', 'factories-sponge-ready-warehouse')"
      ...
      <button
        v-if="$can('read', 'factories-sponge-produce')"
        @click="toggleModal()"
    ...
    <div class="a-table border-b-[1.5px] borderBox dark:border-[#1a283a] min-h-[500px]">
      <div class="table-1" v-if="params.currentTable === 'table-1' && $can('read', 'factories-sponge-coming-raw')">
        <div class="wrapper">
          ...
          <div class="a-table-body" v-if="!isLoading && !isError">
            ...
            >
              ...
              <li class="uk-width-expand">
                <h3 class="a-table-text warn-color" :class="$isDark ? 'dark' : ''">{{ item.factory }}</h3>
              </li>
      ...
      <div class="table-1" v-if="params.currentTable === 'table-2' && $can('read', 'factories-sponge-coming-ready')">
      ...
      <div class="table-2" v-if="params.currentTable === 'table-3' && $can('read', 'factories-sponge-expense')">
        <div class="wrapper border-b-[1.5px] borderBox dark:border-[#1a283a]">
          <div class="a-table-header">
            <ul class="uk-grid-collapse a-table-list" uk-grid>
              <li class="uk-width-expand">
      ...
      <div class="table-4" v-if="params.currentTable === 'table-4' && $can('read', 'factories-sponge-warehouse')">
        <div class="wrapper">
          <div
       ...
       <div class="table-5 h-full" v-if="params.currentTable === 'table-5' && $can('read', 'factories-sponge-ready-warehouse')">
    ...
    <spongeModal :isModalActive="isModalActive" v-if="$can('read', 'factories-sponge-produce')"/>
...
import spongeModal from './components/spongeModal.vue'
...
export default {
  ...
  setup() {
    ...
    const changeTable = async (e) => {
      router.push(`/sponge-factory?table=${e}`)
