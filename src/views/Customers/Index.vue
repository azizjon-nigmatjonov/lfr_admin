<template>
  <section class="pb-20">
    ...
    <!-- =================================================================================================================================================
                                                                    TABLE_SECTION START
    ================================================================================================================================================= -->
    <div class="a-table border-b-[1.5px] borderBox dark:border-[#1a283a] min-h-[500px]" v-if="$can('read', 'customers')">
      <div class="table-1">
        <div class="wrapper">
          ...
          <div class="a-table-body" v-if="!isLoading && !isError">
            ...
            >
              ...
              <!-- <router-link tag="li" class="uk-width-expand" :to="{ name: 'CustomersShow', params: {id: item.id } }">
    ...
    <customersModal :isModalActive="isModalActive" :formCustomer="formCustomer" v-if="$can('read', 'customers-add-modal')"/>
  </section>
...
export default {
  ...
  setup() {
    ...
    const editCustomer = (data) => {
      formCustomer.value = data
      isModalActive.value = !isModalActive.value
      popUpActive.value = null
      const query = { ...route.query }
      router.push({ path: route.fullPath, query: { ...query, page: params.value.pagination.page, customer: data.id } })
    }
    ...
    const deleteCustomer = async (id) => {
        ...
        await suppliersStorage.DELETE_SUPPLIER(id).then( async () => {
          ...
          suppliersStorage.updateCustomer = true
