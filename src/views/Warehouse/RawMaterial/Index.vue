<template>
  <section class="pb-20">
    ...
    <div class="flex items-center justify-between border-y-[1.5px] borderBox dark:border-[#1a283a] wrapper h-[70px]">
      <ul class="basicTab">
        <li
          v-if="$can('read', 'warehouse-raw-coming')"
        ...
        <li
          v-if="$can('read', 'warehouse-raw-expense')"
        ...
        <li
          v-if="$can('read', 'warehouse-raw-warehouse')"
      ...
      <button
        v-if="$can('read', 'warehouse-raw-moving')"
    ...
    <div class="a-table border-b-[1.5px] borderBox dark:border-[#1a283a] min-h-[500px]">
      <div class="table-1" v-if="params.currentTable === 'income' && $can('read', 'warehouse-raw-coming')">
        <div class="wrapper">
      ...
      <div class="table-2" v-if="params.currentTable === 'outcome' && $can('read', 'warehouse-raw-expense')">
        <div class="wrapper">
          <div class="a-table-header">
            <ul class="uk-grid-collapse a-table-list" uk-grid>
              <li class="uk-width-expand">
      ...
      <div class="table-3" v-if="params.currentTable === 'store' && $can('read', 'warehouse-raw-warehouse')">
    ...
    <SendRawMaterialsModal :isModalActive="isModalActive" v-if="$can('read', 'warehouse-raw-moving')"/>
...
import SendRawMaterialsModal from './SendRawMaterialsModal.vue'
...
export default {
  ...
  setup() {
    ...
    const changeTable = (e) => {
      router.push(`/warehouse-raw-material?table=${e}`)
    ...
    const toggleSendFoamModal = async () => {
