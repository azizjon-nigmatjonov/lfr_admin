<template>
  <section class="pb-20">
    ...
    <div class="flex items-center justify-between border-y-[1.5px] borderBox dark:border-[#1a283a] wrapper h-[70px]">
      <ul class="basicTab">
        <li
          v-if="$can('read', 'warehouse-equipment-coming')"
        ...
        <!-- <li
          v-if="$can('read', 'warehouse-equipment-expense')"
        ...
        <li
          v-if="$can('read', 'warehouse-equipment-warehouse')"
    ...
    <div class="a-table border-b-[1.5px] borderBox dark:border-[#1a283a] min-h-[500px]">
      <div class="table-1" v-if="params.currentTable === 'income' && $can('read', 'warehouse-equipment-coming')">
        <div class="wrapper">
          ...
          <div class="a-table-body" v-if="!isLoading && !isError">
            ...
            >
              ...
              <li class="w-[100px] relative">
                <v-confirm v-if="confirmToDeleteProduct == item.id" classes="right-[100px] left-auto top-[15px] -translate-y-1/2" :question="$t('are_realy_want_to_delete_this')" @cancel="() => {confirmToDeleteProduct = null}" @confirm="console.log('aa')" />
                <div
      ...
      <div class="table-2" v-if="params.currentTable === 'outcome' && $can('read', 'warehouse-equipment-expense')">
        <div class="wrapper">
          <div class="a-table-header">
            <ul class="uk-grid-collapse a-table-list" uk-grid>
              <li class="uk-width-expand">
      ...
      <div class="table-3" v-if="params.currentTable === 'store' && $can('read', 'warehouse-equipment-warehouse')">
...
export default {
  ...
  setup() {
    ...
    const changeTable = (e) => {
      router.push(`/warehouse-equipment?table=${e}`)
