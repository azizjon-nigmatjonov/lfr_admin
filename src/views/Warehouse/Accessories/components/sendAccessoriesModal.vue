      ...
      <div class="mt-4 space-y-7">
        ...
        <div class="relative">
          <img
            ...
            alt="user"
          />
          <vue-select :options="productsList" name="title" @select="(option) => form.storage_id = option.id" classes="main-color-black pl-11" :clearSelection="clearSelection"
          :placeholder="$t('accessory_select')" :optionsPagination="params" @refresh="getStoreList($event)" />
...
export default {
    ...
    setup(props) {
        ...
        const toggleModal = () => {
            instance.parent.setupState.toggleSendModal()
        };
