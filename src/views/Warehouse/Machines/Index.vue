<template>
  <section class="pb-20">
    ...
    <div class="flex items-center justify-between border-y-[1.5px] borderBox dark:border-[#1a283a] wrapper h-[70px]">
      <ul class="basicTab">
        <li
          v-if="$can('read', 'warehouse-tech-coming')"
        ...
        <!-- <li
          v-if="$can('read', 'warehouse-tech-expense')"
        ...
        <li
          v-if="$can('read', 'warehouse-tech-warehouse')"
    ...
    <div class="a-table border-b-[1.5px] borderBox dark:border-[#1a283a] min-h-[500px]">
      <div class="table-1" v-if="params.currentTable === 'income' && $can('read', 'warehouse-tech-coming')">
        <div class="wrapper">
      ...
      <div class="table-2" v-if="params.currentTable === 'outcome' && $can('read', 'warehouse-tech-expense')">
        <div class="wrapper">
          <div class="a-table-header">
            <ul class="uk-grid-collapse a-table-list" uk-grid>
              <li class="uk-width-expand">
      ...
      <div class="table-3" v-if="params.currentTable === 'store' && $can('read', 'warehouse-tech-warehouse')">
...
export default {
  ...
  setup() {
    ...
    const changeTable = (e) => {
      router.push(`/warehouse-machines?table=${e}`)
